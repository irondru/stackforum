const ROOT                                     = 'http://localhost:4200/api/v1/'
export const GET                               = 'GET'
export const POST                              = 'POST'
export const PATCH                             = 'PATCH'
export const DELETE                            = 'DELETE'
export const ID                                = '{id}'
export const API_TOPICS_PATH                   = ROOT + 'questions/'
export const API_ANSWER_CREATE_PATH            = API_TOPICS_PATH + '{questionId}/answers'
export const API_SIGN_IN_PATH                  = ROOT + 'users/sign_in'
export const API_SIGN_UP_PATH                  = ROOT + 'users/sign_up'
export const API_SIGN_OUT_PATH                 = ROOT + 'users/sign_out'
export const API_PROFILE_PATH                  = ROOT + 'profile'
export const API_ANSWERS_PATH                  = ROOT + 'answers/'
